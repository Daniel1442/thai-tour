...
const CatalogItemMobile: React.FC<ComponentProps> = ({golf}) => {
                ...
                <div className={'col-12 px-4 pb-3'}>
                    <div className={'col-12 mt-3'}>
                        <div className={'d-flex justify-content-between '}>
                            <div>
                                <h5 className="card-title card-link mb-1"> {golf.name} </h5>
                            </div>
                            <div>
                                <HearthIcon placeId={golf.id}/>
                            </div>
                        </div>
                    ...
                    <div className={'row mt-5 d-flex'}>
                        <div className={'col-12 d-flex justify-content-start'}>
                            ...
                            <b className={'font-red ms-5 mt-2'}> od {golf.price} Kč za os.</b>
