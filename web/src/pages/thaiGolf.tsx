    ...
    return <div className={'homepage'}>
        ...
        <div className={'container'}>
            ...
            <div className={'row'}>
                ...
                <PlaceTripCard heading={'Bangkok'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_bangkok.jpg'}/>
                <PlaceTripCard heading={'Pattaya'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_pattaya.jpg'}/>
                <PlaceTripCard heading={'Hua Hin'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_hua_hin.jpg'}/>
                <PlaceTripCard heading={'Chiang Mai'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_chiang_mai.jpg'}/>
                <PlaceTripCard heading={'Phuket'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_phuket.jpg'}/>
                <PlaceTripCard heading={'Koh Samui'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_koh_samui.jpg'}/>
                <PlaceTripCard heading={'Chiang Rai'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_chiang_rai.jpg'}/>
                <PlaceTripCard heading={'Zobrazit vše'} img={'http://www.thaitour.cz/wp-content/themes/twentyten/images/golf_vse.jpg'}/>
            </div>
            <GolfParagraph paragraph={'Thajsko je fascinující turistická destinace a v současné době si získalo výbornou pověst k prožití exotické dovolené s golfem, a to díky svým skvělým a moderním golfovým hřištím, thajské pohostinnosti, nadstandartním službám, kulturou této země či díky tropickému podnebí, díky kterému zde můžete hrát golf po celý rok!\n' +
                '\n' +
                ...
                '\n' +
                'Světová organizace World Golf Travel Agents Association, která se zabývá golfovou turistikou, vyhlásila Thajsko jako nejlepší destinaci na světě pro exotickou dovolenou s golfem. Pomohla tomu jistě široká nabídka skvělých golfových hřišť po celém Thajsku, které každým rokem a celoročně přitahují mnoho golfistů z celého světa.'} img={'http://www.thaitour.cz/wp-content/uploads/2013/10/Golf1-230x200.jpg'} heading={'Dovolená v Thajsku s golfem'}/>
            <GolfParagraph paragraph={'Thajsko nabízí rozličný golf, a to hlavně díky své rozmanité krajině, jsou zde roviny, ale také nádherné hory. Hledáte-li golfové hřiště v horském prostředí, u plážového resortu či v okolí měst Bangkok a Pattaya, všude najdete hřiště, která budou splňovat vaše nejvyšší nároky.\n' +
                '\n' +
