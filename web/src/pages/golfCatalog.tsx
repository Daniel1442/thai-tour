...
const GolfCatalog = () => {
    ...
    return (<div className={'container'}>
        <h1 className={'mt-5'}>Golf v Thajsku</h1>
        <div className={'row'}>
            <div className={'col-12'}>
                <h3 className={'mt-5 mb-3'}>Destinace pro golf v Thajsku</h3>
            </div>

            {cities && cities.map((city) => { return <GolfCitiesCard city={city}/>})}
            <GolfCitiesCard city={{id: "", icon:"http://www.thaitour.cz/wp-content/themes/twentyten/images/vylet_vse.jpg", name: "Zobrazit vše"} as CityRow}/>
        </div>
        <div className={'row'}>
            <GolfParagraph
